...
from sqlalchemy import String, Text, Integer, ForeignKey, Enum as SQLEnum, Date, DateTime, Float
...
class Task(Base, TimestampMixin):
    ...
    obsidian_path: Mapped[Optional[str]] = mapped_column(String(1000), nullable=True)
